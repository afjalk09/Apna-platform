...
const contacts = [
  ...
  },
  {
    ...
    icon: Mail,
    href: "mailto:hello@apnaplatform.com",
    color: "text-blue-500",
    bg: "bg-blue-50",
  },
  {
    label: "LinkedIn",
    value: "linkedin.com/company/apnaplatform",
    icon: LinkedinIcon,
    href: "https://linkedin.com/company/apnaplatform",
    color: "text-blue-700",
    bg: "bg-blue-50",
  },
  {
    ...
    value: "@apna_platform",
    icon: InstagramIcon,
    href: "https://instagram.com/apna_platform",
    color: "text-pink-500",
    bg: "bg-pink-50",
  },
];
